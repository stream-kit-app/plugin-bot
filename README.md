# Bot plugin distribution

This repository publishes the official **Stream Kit** distribution for the **Bot** plugin (`bot`).
...
1. Download `plugin-bot.zip` from the [latest release](https://github.com/stream-kit-app/plugin-bot/releases/latest).
